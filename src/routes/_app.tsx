...
import { LayoutDashboard, Receipt, CalendarRange, HandCoins, Upload, FileBarChart, LogOut, Bell, Menu, ShieldCheck, Clock, Lock } from "lucide-react";
...
const baseNav = [
  ...
  { to: "/movimentacoes", label: "Movimentações", icon: Receipt, viewer: false },
  { to: "/importar", label: "Importar extrato", icon: Upload, viewer: false },
